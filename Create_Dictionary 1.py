def load_sys():
    ...
    sys_dict = {
        'd_ox': {
            ...
            'pkl': '../feature_generation_MDAnalysis/d_ox_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/d_ox_CA_distances_MDAanalysis_eq.pkl',
            'target': 0,
            'system_index': 1
        },
        ...
        'd_red': {
            ...
            'pkl': '../feature_generation_MDAnalysis/d_red_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/d_red_CA_distances_MDAanalysis_eq.pkl',
            'target': 0,
            'system_index': 2
        },
        ...
        'b_ox': {
            ...
            'pkl': '../feature_generation_MDAnalysis/b_ox_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/b_ox_CA_distances_MDAanalysis_eq.pkl',
            'target': 1,
            'system_index': 3
        },
        ...
        'b_red': {
            ...
            'pkl': '../feature_generation_MDAnalysis/b_red_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/b_red_CA_distances_MDAanalysis_eq.pkl',
            'target': 1,
            'system_index': 4
        },
        ...
        'R121S': {
            ...
            'pkl': '../feature_generation_MDAnalysis/R121S_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/R121S_CA_distances_MDAanalysis_eq.pkl',
            'target': 1,
            'system_index': 5
        },
        ...
        'Y126F': {
            ...
            'pkl': '../feature_generation_MDAnalysis/Y126F_CA_distances_MDAanalysis.pkl',      
            'eq_pkl': '../feature_generation_MDAnalysis/Y126F_CA_distances_MDAanalysis_eq.pkl',
            'target': 0,
            'system_index': 6
        },
        ...
        'P141G': {
            ...
            'pkl': '../feature_generation_MDAnalysis/P141G_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/P141G_CA_distances_MDAanalysis_eq.pkl',
            'target': 0,
            'system_index': 7
        },
        ...
        'With': {
            ...
            'pkl': '../feature_generation_MDAnalysis/With_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/With_CA_distances_MDAanalysis_eq.pkl',
            'target': 1,
            'system_index': 8
        },
        ...
        'WithOut': {
            ...
            'pkl':  '../feature_generation_MDAnalysis/WithOut_CA_distances_MDAanalysis.pkl',
            'eq_pkl': '../feature_generation_MDAnalysis/WithOut_CA_distances_MDAanalysis_eq.pkl',
            'target': 1,
            'system_index': 9
        }
    }
